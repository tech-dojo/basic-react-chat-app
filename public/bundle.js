...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = function (_React$Component2) {
	    ...
	    function CommentBox() {
	        ...
	        _this2.state = { data: [] };
	        _this2.updateCommentList = _this2.updateCommentList.bind(_this2);
	    ...
	    _createClass(CommentBox, [{
	        ...
	        value: function updateCommentList(payload) {
	            this.setState({
	                data: payload
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(CommenForm, { onCommentSubmit: this.handleCommentSubmit.bind(this) })
	            );
	        }
	    }]);
	...
	var CommenForm = function (_React$Component5) {
	    _inherits(CommenForm, _React$Component5);

	    function CommenForm() {
	        _classCallCheck(this, CommenForm);

	        var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(CommenForm).call(this));

	        _this5.state = { author: '', text: '' };
	        return _this5;
	    }

	    _createClass(CommenForm, [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WebSocket = BrowserWebSocket || (typeof window !== 'undefined' ? null : __webpack_require__(198));
